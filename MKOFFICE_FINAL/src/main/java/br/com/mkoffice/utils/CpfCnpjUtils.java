...
public abstract class CpfCnpjUtils {
	...
	/*
	 * documento: numero do Cpf ou Cnpj formatado
	 * 
	 * Comum para os 2 tipos de documentos
	 */
	public static Long extraiCpfCnpjPrincipal(String sdocumento){
		...
		// Deve - se validar o tamanho da string pois, caso ela seje referente ao CNPJ seu tamanho será de 14, sabendo que a string que contém o CPF terá 9 campos e a string que contém
		// o CNPJ contém 8 campos, devemos atribuir o numero zero ao inicio do CNPJ.
		...
		// pega somente as 9 primeiras posiçoes.
		return Long.parseLong(documento.substring(0, 9));
	}

	/*
	 * Documento: numero do Cnpj formatado
	 * 
	 * Não se aplica ao CPF. - Returna 0.
	 */
	public static Integer extraiCnpjFilial(String sdocumento){
		...
		// se for cpf, retorna 0.
		if (documento.length() == 11) {
			return 0;
		}
		else
		{
		// pega os digitos referente a filial - posicoes 9 a 13
	...
	public static Integer extraiCpfCnpjDigito(String sdocumento){
		...
		// pega somente as 2 ultimas posicoes;
	 ...
	 * @return Terá como retorno o número principal do CPF/CNPJ.
	 * 
	 * entrada: 131073898000073   - CPF vindo da base PIC 9(15)
	 * 			046189718000179   - CNPJ vindo da base PIC 9(15)
	 * 
	 * Retorno:  131073898  como long.
	 * 			 46189718   como long.
	 * 
	 * o tamanho da variavel de entrada poderá variar	    
	 */
	public static Long extrairCpfCnpjPrincipalLong(Long cpfCnpj){
		...
		//Sempre utilizamos como referencia o digito de controle e o número filial que sempre existirão, portanto o resto será sempre o corpo principal.
		String corpoPrincipal = valorFormatado.substring(0,valorFormatado.length() - 6);
		
		//Caso não exista corpo principal no CPF/CNPJ então será passado 0 como retorno.
	...
	public static Integer extrairCpfCnpjFilialInteiro(Long cpfCnpj){
		...
		//Sempre utilizamos como referencia o digito de controle e o número filial que sempre existirão, portanto o filial será o índice entre o final -6 e o final -2, onde final é o tamanho do campo.
	 ...
	 * 
	 * @param cpfCnpj Este campo pode ser tanto um CPF quanto um CNPJ.
	 * @return Terá como retorno o dígito de controle do CPF/CNPJ.
	 * 
	 *
	 * entrada: 131073898000073   - CPF vindo da base PIC 9(15)
	 * 			046189718000179   - CNPJ vindo da base PIC 9(15)
	...
	public static Integer extrairCpfCnpjDigitoControleInteiro(Long cpfCnpj){
		...
		//Sempre utilizamos como referencia o digito de controle e o número filial que sempre existirão, portanto o digito de controle será o índice entre o final -2 e o final, onde final é o tamanho do campo.
	 ...
	 * 
	 * @param cpfCnpj Este campo pode ser tanto um CPF quanto um CNPJ.
	 * @return Terá como retorno o campo CPF/CNPJ no formato Long.
	 * 
	 ...
	 * 
	 * @param cpfCnpj Este campo pode ser tanto um CPF quanto um CNPJ.
	 * @return Terá como retorno o campo CPF/CNPJ no formato String.
	 * 
	 * Entrada: campo formatado como String:
	 * 			CPF: 123.456.789-09
	 * 			CNPJ: 64.481.427/0001-31
	 ...
	 * 
	 * Retorno: campo com tamanhos de 11 ou 14, adicionando 0 à filial caso CPF.
	 * 			CPF:  131073898000003
	...
	public static Long formatarCpfCnpjLong(String cpfCnpj){
		...
		//Caso ocorra uma barra na formatação, então poderemos tratar este campo como CNPJ
		...
		}//Caso NÃO ocorra uma barra na formatação, então poderemos tratar este campo como CPF
		else{

...
public class ParcelaRepository extends JpaGenericDao<ParcelasEntity, Long> {
	...
	public List<ParcelasEntity> filterByDateSituacaoPagoContasPagar(Date dataInicial, Date dataFinal) {
	...
	public List<ParcelasEntity> filterByDateSituacaoPendenteContasPagar(Date dataInicial, Date dataFinal) {
		StringBuilder query = new StringBuilder();
		query.append("SELECT p FROM ParcelasEntity p").append(" ");
		query.append("where p.codPedido.codPedido IS NOT NULL").append(" ");
		if(dataInicial != null){
	...
	public List<ParcelasEntity> filterByDateSituacaoPagoContasReceber(Date dataInicial, Date dataFinal) {
	...
	public List<ParcelasEntity> filterByDateSituacaoPendenteContasReceber(Date dataInicial, Date dataFinal) {
		StringBuilder query = new StringBuilder();
		query.append("SELECT p FROM ParcelasEntity p").append(" ");
		query.append("where p.codVenda.codVenda IS NOT NULL").append(" ");
		if(dataInicial != null){

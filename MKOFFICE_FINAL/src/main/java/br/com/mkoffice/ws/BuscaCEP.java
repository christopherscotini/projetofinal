...
public class BuscaCEP implements CEPService {
	...
	private static final String XPATH_TABELA_RESULTADO_CONSULTA = "//*[@class='laminas']/div[2]/div[2]/div[2]/div/table[1]";
	...
	private HtmlTable getHtmlTableWithResults(String query){
		try {
			final HtmlPage page = getWebClient().getPage(BUSCA_CEP_SERVICE_BASE_URL + query);
			final HtmlTable table = (HtmlTable) page.getByXPath(XPATH_TABELA_RESULTADO_CONSULTA).get(0);

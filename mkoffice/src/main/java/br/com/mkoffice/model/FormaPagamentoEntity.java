...
import br.com.mkoffice.dto.FormaPagamentoDTO;
...
public class FormaPagamentoEntity implements Serializable{
	...
	public static FormaPagamentoEntity convertDTOToEntity(FormaPagamentoDTO dto){
		FormaPagamentoEntity entity = new FormaPagamentoEntity(
				dto.getId()
				, dto.getDescFormaPgto()
				, dto.isPossuiParcelas()

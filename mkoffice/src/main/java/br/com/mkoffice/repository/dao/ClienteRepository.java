...
public class ClienteRepository extends JpaGenericDao<ClienteEntity, Long>{
	...
	public List<ClienteEntity> findByFiltroPesquisa(Long codClienteFiltro,
...
//	private List<ClienteEntity> recuperarOcorrencias(List<ClienteEntity>listaRetornada){
...
//				dto.setDadosPessoa(PessoaDTO.entityToDTO(listaRetornada.get(i).getDadosPessoa()));
...
//				dto.setListaVendas(VendaDTO.listaVendaEntityToDto(listaRetornada.get(i).getListaVendas()));
//				dto.setUsuario(UserDTO.entityToDTO(listaRetornada.get(i).getUsuario()));
//				listaSaida.add(dto);
//			}
//		}
//		return listaSaida;
